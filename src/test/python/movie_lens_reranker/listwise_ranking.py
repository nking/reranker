...
class RankingModel(keras.Model):
    ...
    def build(self, input_shape):
        ...
        #output_shape is (None, 5, 32).  input to this is (None, 5, 64)
    ...
    def call(self, inputs):
        ...
        #user_emb_repeated is (None, 5, 32), candidate_emb is (None, 5, 32).  concate is (None, 5, 64)
        ...
        print(f'user_embeddings={user_embeddings}')
        print(f'candidate_embeddings={candidate_embeddings}')
        print(f'candidate shape=={candidate_embeddings.shape}')
        print(f'scores={scores}')

        return scores #(None, 5)
